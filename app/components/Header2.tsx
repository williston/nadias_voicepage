               ...
               <div id='help' className={`flex flex-row justify-between md:w-full items-start font-sans  ${eb_garamond.className}`}>
                  <div className='flex flex-col justify-start'>
                   ...
                   <div className='flex flex-col items-center mt-2 md:mt-auto'>
                     <p className='font-bold uppercase text-sm md:text-4xl -mr-2 md:mr-0'>Nadia Verde</p>
                  ...
                  <div className=''>
                     <p className='text-xs md:text-base -ml-3 md:ml-0'>nadiaverde03@gmail.com</p>
                     <p className='text-xs md:text-base'>+1(323) 643-5428</p>
                  </div>
               </div>
